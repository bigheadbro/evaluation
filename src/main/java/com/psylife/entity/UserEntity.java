...
public class UserEntity implements Serializable {
	...
	/**
	 * @param freedom the freedom to set
	 */
	...
	/**
	 * @param wtrip the wtrip to set
	 */
	public void setWtrip(int wtrip) {
		this.wtrip = wtrip;
	}
	 ...
	 * @return the stateown
	 */
	public int getStateown() {
		return stateown;
	}

	/**
	 * @param stateown the stateown to set
	 */
	public void setStateown(int stateown) {
	...
	/**
	 * @param privat the privat to set
	 */
	...
	/**
	 * @param commonweal the commonweal to set
	 */
