	...
	public void init() {
		...
		try {
			connection = java.sql.DriverManager
					.getConnection(
							"jdbc:mysql://114.80.208.103:60306/evaluation?useUnicode=true&amp;characterEncoding=utf-8",
							"root", "123123");
	...
	public static void main(String[] args) throws SQLException {
		...
		for(String table:args)
		{
			...
			try {
				...
				// 输出
			    //Writer sw = new PrintWriter(new FileOutputStream(new File("src/main/resources/mapper/psylife/entity/"+entity.getEntityName()+".java")));
